...
/*
 *
 * Create Openstack project,user,network,vm instances
 * @params $user_name
 */

function kick_ansible( $user_name){
    require "kickAnsible/data.php";
    ...
    $command = "echo $sudo_pass | sudo -S /opt/python2.7.10/bin/ansible-playbook /opt/local/lqtGS/site.yml";
    ...
    file_put_contents("/opt/local/lqtGS/os_user_test.log",$output);
